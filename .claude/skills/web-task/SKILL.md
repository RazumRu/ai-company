...
Execute the following task in the **geniro/apps/web/** repository:

$ARGUMENTS

## Before Starting

1. Read `geniro/apps/web/CLAUDE.md` for full project context and architecture.
...
```bash
cd geniro/apps/web && pnpm run full-check
```
