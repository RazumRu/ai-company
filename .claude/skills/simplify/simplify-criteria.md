...
Reference file shared between `/simplify` skill and `/implement` Phase 6. Contains the three analysis passes, severity classification, anti-patterns, and ground rules for code simplification.
