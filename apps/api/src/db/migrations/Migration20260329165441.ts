...
export class Migration20260329165441 extends Migration {
  override up(): void | Promise<void> {
    ...
    this.addSql(
      `alter index "IDX_0d463e583f3363c4a3b1d179d9" rename to "git_provider_connections_user_id_index";`,
    );
    this.addSql(
      `alter index "IDX_4e2c304727084db04db41794e8" rename to "git_provider_connections_provider_index";`,
    );
    this.addSql(
      `alter table "git_provider_connections" drop constraint "UQ_d33e8a47a1b87f23975eec7bee7";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter index "IDX_cdd40dd1e9a0c0ea2d77ea9f48" rename to "git_repositories_created_by_index";`,
    );
    this.addSql(
      `alter index "IDX_21cc46a19a72cc0fb71d443676" rename to "git_repositories_project_id_index";`,
    );
    this.addSql(
      `alter index "IDX_ac33bc6a5803234be00dc839bc" rename to "git_repositories_owner_index";`,
    );
    this.addSql(
      `alter index "IDX_d9121f1e2ce469c0f140253b0f" rename to "git_repositories_repo_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_3cab3aab51c7394a1133560768" rename to "graph_checkpoints_parent_thread_id_index";`,
    );
    this.addSql(
      `alter index "IDX_bf2c48c6e6ae3bffe3b737dbda" rename to "graph_checkpoints_node_id_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_2db6fd00099882ad81ce3a5be4" rename to "graphs_created_by_index";`,
    );
    this.addSql(
      `alter index "IDX_16c67c5ed33f8ad80686455df5" rename to "graphs_project_id_index";`,
    );
    this.addSql(
      `alter index "IDX_4b71a57204c9102cdc0c1a9f51" rename to "graphs_status_index";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter index "IDX_c16df53f74a9053299af7a1740" rename to "graph_revisions_graph_id_index";`,
    );
    this.addSql(
      `alter index "IDX_9c3be1885dfe18d1c59675de45" rename to "graph_revisions_status_index";`,
    );
    this.addSql(
      `alter index "IDX_8656c524a47fa65047677f6825" rename to "graph_revisions_created_by_index";`,
    );
    this.addSql(
      `alter index "IDX_31c0acef25b5e1204c253aaad1" rename to "graph_revisions_graph_id_to_version_index";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter index "IDX_68cd1c26fb287057a76150f247" rename to "knowledge_docs_created_by_index";`,
    );
    this.addSql(
      `alter index "IDX_e847cd5e64a00441fb254b4248" rename to "knowledge_docs_project_id_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_4fcfae511b4f6aaa67a8d32596" rename to "projects_created_by_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_1de5896f100d9e9b87875424ac" rename to "repo_indexes_status_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_9d7d3e71a836499597201eb7ca" rename to "runtime_instances_graph_id_index";`,
    );
    this.addSql(
      `alter index "IDX_9c8681731cc6cc3f8e1d8616ee" rename to "runtime_instances_thread_id_index";`,
    );
    this.addSql(
      `alter index "IDX_cc42483a7c938297472ef633c9" rename to "runtime_instances_status_index";`,
    );
    this.addSql(
      `alter index "IDX_aee88a311dcb1339c9c5d7314b" rename to "runtime_instances_last_used_at_index";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter index "IDX_d288e139037a4de52d00e42e78" rename to "threads_created_by_index";`,
    );
    this.addSql(
      `alter index "IDX_3acbab3c91ef7c75eb0709f44f" rename to "threads_project_id_index";`,
    );
    this.addSql(
      `alter index "IDX_6702c6b1e71ab29e5103028183" rename to "threads_graph_id_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_c69829dccdf02bb79717b83271" rename to "threads_status_index";`,
    );
    ...
    this.addSql(
      `alter index "IDX_15f9bd2bf472ff12b6ee20012d" rename to "messages_thread_id_index";`,
    );
    this.addSql(
      `alter index "IDX_0d56ed722567bad03618f7e02b" rename to "messages_external_thread_id_index";`,
    );
    this.addSql(
      `alter index "IDX_7f5346b8f042a49c31dbf19870" rename to "messages_node_id_index";`,
    );
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(
      `alter table "messages" drop constraint "messages_thread_id_foreign";`,
    );

    this.addSql(
      `alter table "repo_indexes" drop constraint "repo_indexes_repository_id_foreign";`,
    );
    ...
    this.addSql(
      `alter table "threads" drop constraint "threads_graph_id_foreign";`,
    );
    ...
    this.addSql(
      `alter table "git_provider_connections" drop constraint "git_provider_connections_user_id_provider_account_login_unique";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "git_repositories" drop constraint "git_repositories_provider_check";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "graph_revisions" drop constraint "graph_revisions_status_check";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "repo_indexes" drop constraint "repo_indexes_status_check";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "runtime_instances" drop constraint "runtime_instances_status_check";`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "webhook_sync_state" drop constraint "webhook_sync_state_type_check";`,
    );
    this.addSql(
