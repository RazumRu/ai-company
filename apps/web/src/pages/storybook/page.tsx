...
const STORYBOOK_REPOS: Repository[] = [
  {
    ...
    index: {
      id: 'idx-1',
      repositoryId: 'sb-1',
      repoUrl: 'https://github.com/my-org/backend-api',
      branch: 'main',
      status: 'completed',
      qdrantCollection: 'sb-1-main',
  ...
  },
  {
    ...
    index: {
      id: 'idx-3',
      repositoryId: 'sb-3',
      repoUrl: 'https://github.com/my-org/data-pipeline',
      branch: 'develop',
      status: 'failed',
      qdrantCollection: 'sb-3-develop',
      lastIndexedCommit: null,
      embeddingModel: null,
      vectorSize: null,
      chunkingSignatureHash: null,
...
/* -------------------------------------------------------------------------- */
/*  Thread Token Usage Line section                                           */
/* -------------------------------------------------------------------------- */

function ThreadTokenUsageLineSection() {
  return (
    <Section
      id="thread-token-usage-line"
      title="Thread Token Usage Line"
      description="Compact token/cost summary shown on chat threads. Supports optional cost limits and stop-reason indication.">
      <Row label="No limit">
