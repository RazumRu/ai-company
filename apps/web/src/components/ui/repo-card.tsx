...
export type IndexStatus = RepoIndexDtoStatusEnum | 'not_indexed';

export type Repository = GitRepositoryDto & { index?: RepoIndexDto };
...
function getProgress(index?: RepoIndexDto): number {
  if (!index) {
    return 0;
  }
...
export function RepoProgressBar({ index }: { index?: RepoIndexDto }) {
