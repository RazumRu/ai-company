...
| --------------- | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- | --------------------------------- |
| **messages**    | [**Array&lt;ExecuteTriggerDtoMessagesInner&gt;**](ExecuteTriggerDtoMessagesInner.md) | Array of messages — plain strings or structured objects with content blocks | [default to undefined]            |
